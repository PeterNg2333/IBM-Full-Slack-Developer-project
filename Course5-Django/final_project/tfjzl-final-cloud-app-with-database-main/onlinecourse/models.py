...
## For the final project, you will implement the following models:
...
class Question(models.Model):
    content= models.CharField(null=False, max_length=1000, default='question')
    grade = models.IntegerField(null=True, default=0)
    course = models.ForeignKey(Course, on_delete=models.CASCADE)

    def __str__(self):
        return "Question is: {}".format(self.content)
...
class Choice(models.Model):
    content = models.CharField(null=False, max_length=200, default='choice')
